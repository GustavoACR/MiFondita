...
function Header() {
  return (
    <header className="border-b border-black w-full bg-white">
      ...
      <div className="mt-5 mb-10 flex items-center justify-center">
        <img
          className="h-[200px] md:h-[250px] w-auto hover:shadow-inner focus:outline-none transition duration-500 ease-in-out transform hover:-translate-x hover:scale-105"
          src={Logo}
          alt="Logo"
        />
      </div>

      <div className="flex flex-col sm:flex-row items-center justify-between px-5 sm:px-10 py-3 sm:py-5 text-base sm:text-lg md:text-xl">
        <div className="sm:mb-0 mb-3 sm:mr-5 md:min-w-[200px]">
          <Link
            to="/"
        ...
        <div className="flex items-center space-x-5 sm:space-x-10 md:min-w-[200px]">
          <button
            onClick={() => {}}
            className="hover:scale-105"
          >
        ...
        <div className="flex items-center md:min-w-[200px]">
          ...
          <span className="text-base sm:text-lg">631-167-1042</span>
        </div>
      </div>
    </header>
  );
