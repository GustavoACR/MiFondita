    ...
    <div className="bg-blue-200">
      ...
      <div className="sm:h-[550px] bg-green-400 py-5">
        <div className="flex flex-col sm:flex-row items-center justify-between px-5 sm:px-5">
          <div>
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold font-rammettoOne mb-4">¡Bienvenidos al nuevo restaurante!</h1>
            <p className="text-base sm:text-xl font-aronesans">¡Estamos emocionados de presentarles nuestro nuevo restaurante!</p>
            <p className="mt-4 text-base sm:text-xl font-aronesans">Aquí está nuestra oferta especial de inauguración:</p>
            <div className="mt-2 font-aronesans">
            ...
            <p className="mt-4 text-base sm:text-xl font-aronesans">¡No se pierdan nuestra oferta especial de inauguración y vengan a disfrutar de una experiencia gastronómica única!</p>
          </div>
          <div className="mt-5">
            <img
      ...
      <div className="h-[500px] bg-yellow-300">
        <div className="flex flex-col sm:flex-row items-center justify-between px-5">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-rammettoOne">¡Ven y visítanos!</h1>
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-rammettoOne">Toda una experiencia de sabor</h1>
          </div>
        </div>
      </div>
      ...
      <div className="sm:h-[600px] bg-green-400">
        <div className="flex flex-col sm:flex-row items-center justify-between px-5 sm:px-10 sm:py-10 md:py-10 lg:py-10">
          <div className="mt-10 md:mt-0 sm:mt-0 font-aronesans">
