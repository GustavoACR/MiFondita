    ...
    <div className="bg-stone-200">
      ...
      <div className="flex justify-center items-center py-8">
        <div className="text-center">
          <h1 className="text-5xl md:text-7xl lg:text-7xl font-bold font-neonderthaw mb-4">¡Bienvenido al nuevo restaurante!</h1>
          <p className="text-xl text-gray-900 md:text-2xl lg:text-4xl font-rammettoOne mb-4">Desayunos, comidas y más!!</p>
        </div>
      </div>
      ...
      <div className="py-8 border-t border-black">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="mb-8 md:mb-0 md:min-w-[250px]">
            <p className="text-center font-bold font-truculenta text-3xl md:text-4xl mb-3">Desayunos</p>
            <ul className="text-base font-fresca md:text-md lg:text-xl list-disc ml-6">
      ...
      <div className="md:py-8 sm:py-0 lg:px-5 md:border-b md:border-t md:border-black">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:mb-0">
            <p className="text-center font-bold font-truculenta text-3xl md:text-4xl mb-3">Comidas</p>
            <ul className="text-base font-fresca md:text-md lg:text-xl list-disc ml-6">
            ...
            <p className="text-center font-bold font-truculenta text-3xl md:text-4xl mb-3">Extras</p>
            <ul className="text-base font-fresca md:text-md lg:text-xl list-disc ml-6">
          ...
          <div className="mb-8 md:mb-0">
            <img
              className="h-[300px] w-auto md:h-[250px] lg:h-[400px] lg:w-[400px] object-cover"
              src={pay}
              alt="Omelette"
            />
          </div>
          <div className="mb-8 md:mb-0">
            <p className="text-center font-bold font-truculenta text-3xl md:text-4xl mb-3">Snacks</p>
            <ul className="text-base font-fresca md:text-md lg:text-xl list-disc ml-6">
      ...
      <div className="md:py-8 sm:py-0 sm:mb-5">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="mb-8 md:mb-0">
            <img
              className="h-[300px] w-auto lg:h-[400px] lg:w-[400px] object-cover"
          ...
          <div className="mb-8 md:mb-0 min-w-[280px]">
            <p className="text-center font-bold font-truculenta text-3xl md:text-4xl mb-3">Bebidas</p>
            <ul className="text-base font-fresca md:text-lg lg:text-xl list-disc ml-6">
          ...
          <div className="items-center justify-center text-center">
            <img
              className="h-[250px] w-auto lg:h-[400px] object-cover flex items-center justify-center"
              src={Logo}
              alt="Sanwis"
            />
          </div>
